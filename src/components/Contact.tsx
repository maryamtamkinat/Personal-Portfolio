  ...
  return (
    <section id="contact" className='mt-32 mb-14 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto'>
      ...
      <div className='flex flex-col lg:flex-row justify-between gap-10'>
        {/* Left Side */}
        <div className='lg:w-1/2 flex flex-col justify-start mt-5' data-aos="fade-right">
          <h2 className='text-2xl font-semibold mb-6'>Let's Connect Together</h2>
        ...
        <form
          onSubmit={onSubmit}
          className='lg:w-1/2 border-[0.1px] border-gray-600 hover:border-gray-500 p-6 md:p-8 shadow-xl rounded-md bg-[#1a1a1a]'
          data-aos="fade-left"
        >
         ...
         <button className="w-full text-white py-2 rounded-md bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 transform active:scale-95 transition duration-300">
               Submit
            </button>
